...
export function PostDetailClient({ post, consultation }: PostData) {
            ...
            <div className="max-w-4xl mx-auto space-y-8">
                <header className="flex justify-between items-center mb-12">
                    ...
                    <Button
                        ...
                        onClick={() => router.replace(`/blog/edit/${post.id}`)}
                    >
                ...
                <Card className="p-8 bg-background/60 backdrop-blur-md shadow-sm border-none">
                    {post.images && Array.isArray(post.images) && post.images.length > 0 && <GalleryLightbox images={post.images} />}
                ...
                {post.mode === 'consultation' && consultation && (
                    <motion.div
                            ...
                            <DialogContent className="sm:max-w-md bg-white/95 dark:bg-zinc-900/95 backdrop-blur-xl border-slate-200 dark:border-zinc-800">
                                ...
                                <div className="space-y-4 py-4">
                                    <p className="text-sm text-muted-foreground">
                                        오늘 나의 마음을 가장 잘 표현하는 문장을 자유롭게 적어주세요.
                                    </p>
                                    <Input
