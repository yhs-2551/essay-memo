            ...
            >
                <div className='bg-slate-900/95 dark:bg-slate-800/95 backdrop-blur-2xl border border-white/10 rounded-3xl p-3 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex items-center justify-between gap-2'>
                    <div className='flex items-center gap-1'>
                        <Button variant='ghost' size='icon' onClick={onClear} className='text-white hover:bg-white/10 rounded-full h-10 w-10'>
                            <X className='h-5 w-5' />
                        </Button>
                    ...
                    <div className='flex items-center gap-2'>
                        <Button variant='ghost' size='sm' onClick={onSelectAll} className='text-white/70 hover:text-white hover:bg-white/10 text-xs'>
