...
export const useImageUpload = (bucketName: string = 'images'): UseImageUploadResult => {
  ...
  const handlePaste = useCallback(async (e: React.ClipboardEvent): Promise<string | null> => {
